...
BEGIN
	...
	GENERIC MAP (
		...
		rfs1 => "fft_1n512sin.hex",
		rfs2 => "fft_2n512sin.hex",
		rfs3 => "fft_3n512sin.hex",
		rfc1 => "fft_1n512cos.hex",
		rfc2 => "fft_2n512cos.hex",
		rfc3 => "fft_3n512cos.hex"
	)
	PORT MAP (
		clk  =>  clk,
		reset_n  =>  reset_n,
...
-- Retrieval info:      <PRIVATE name = "NUM_LE" value="4375"  type="INTEGER"  enable="1" />
