...
ARCHITECTURE SYN OF fft IS
	...
	COMPONENT asj_fft_dualstream_fft_131
	GENERIC (
		nps	: NATURAL;
		bfp	: NATURAL;
		nume	: NATURAL;
...
BEGIN
	...
	asj_fft_dualstream_fft_131_inst : asj_fft_dualstream_fft_131
	GENERIC MAP (
		nps => 4096,
		bfp => 1,
		nume => 2,
		...
		rfs1 => "fft_1n4096sin.hex",
		rfs2 => "fft_2n4096sin.hex",
		rfs3 => "fft_3n4096sin.hex",
		rfc1 => "fft_1n4096cos.hex",
		rfc2 => "fft_2n4096cos.hex",
		rfc3 => "fft_3n4096cos.hex"
	)
	PORT MAP (
		clk  =>  clk,
		reset_n  =>  reset_n,
