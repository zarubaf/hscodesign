...
\begin{frame}\frametitle{SysC vs. C Architecture} 
Architecture code in SystemC auf der linken spalte.
C code auf der rechten spalte.
\end{frame}
\begin{frame}\frametitle{SysC vs. VHDL Architecture} 
Architecture code in SystemC auf der linken spalte.
VHDL code auf der rechten spalte.
\end{frame}

\subsection{Examples - Comparison}
\begin{frame}\frametitle{SysC vs. C Entity} 
Entity code in SystemC auf der linken spalte.
C code auf der rechten spalte.
\end{frame}
\begin{frame}\frametitle{SysC vs. VHDL Entity} 
Entity code in SystemC auf der linken spalte.
VHDL code auf der rechten spalte.
\end{frame}

\subsection{Examples - Question}
\begin{frame}\frametitle{SysC} 
